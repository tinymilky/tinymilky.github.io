...
spec.num_hidden_units = 3; // number of neurons in hidden layer
...
$(document).keydown(function(e) {
    ...
    if (e.keyCode == 37) {
        ...
        // playerJump();
        // var action = agent.act(state);
        var r = env.sampleNextState(0);
        agent.learn(r);
    } else if (e.keyCode == 39) {
        var state = env.getState();
        // playerJump();
        // var action = agent.act(state);
        var r = env.sampleNextState(1);
        agent.learn(r);
